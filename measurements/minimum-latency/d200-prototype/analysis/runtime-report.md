...
| --- | ---: | ---: | ---: | ---: |
| `LL` | 42 | +0.11 / 0.77 dB | 7.22 / 10.34 dB | -36.54 dB |
| `LR` | 54 | -0.15 / 0.74 dB | 8.91 / 12.52 dB | -34.95 dB |
| `RL` | 55 | -0.06 / 0.66 dB | 8.60 / 11.23 dB | -35.60 dB |
| `RR` | 41 | +0.26 / 0.93 dB | 7.98 / 12.78 dB | -35.83 dB |

## Decision

The runtime capture validates routing, timing, headroom, CPU load, and generated-asset closure. It does not pass the tonal gate: the 80–200 Hz RMS error is 7.22–8.91 dB. Keep this first prototype as a diagnostic and use the A-matched revision for the listening candidate.
