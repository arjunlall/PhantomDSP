...
> Capture the opt-in D200 A-matched renderer described in `measurements/minimum-latency/README.md`. First read `AGENTS.md`, that README, `measurements/minimum-latency/d200-a-matched/analysis/report.md`, `tools/measurement/run_eapo_d200_a_matched.ps1`, and `tools/measurement/run_eapo_baseline.ps1`.
>
